...
define(["three", "threex", "bunnies"], function(THREE, THREEx, bunnies) {
  return new ((function() {
    ...
    _Class.prototype.init = function() {
      ...
      this.size();
      supportsOrientationChange = indexOf.call(window, 'onorientationchange') >= 0;
      ...
      window.addEventListener('deviceorientation', ((function(_this) {
        return function(event) {
          var beta, gamma, ref;
          return ref = _this.width < _this.height ? [event.beta, event.gamma] : (beta = -event.gamma, gamma = event.beta, Math.abs(gamma) > 90 ? beta = 180 - beta : void 0, [beta, gamma]), _this.forward = ref[0], _this.side = ref[1], ref;
        };
      })(this)), true);
