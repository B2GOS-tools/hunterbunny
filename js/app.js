  ...
  return new ((function() {
    ...
    _Class.prototype.init = function() {
      ...
      window.addEventListener('deviceorientation', ((function(_this) {
        return function(event) {
          var forward, side, _base, _base1, _base2, _base3, _ref;
          _ref = window.innerWidth > window.innerHeight ? [event.gamma, event.beta] : [event.beta, event.gamma], forward = _ref[0], side = _ref[1];
